...
Public Class pembelian
    ...
    Sub tampil()
        koneksi.Close()
        buka()
        cmd = New SqlClient.SqlCommand("SELECT kode_brg,nama_brg,jml_beli,harga FROM tbl_det_beli where nonota='" & txt_no_nota.Text & "'", koneksi)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim pesan As String
        sql = "update tbl_beli set total='" & Xtotal.Text & "'where nonota ='" & txt_no_nota.Text & "'"
        cmd.Dispose()
    ...
    Private Sub tambah_Click(sender As Object, e As EventArgs) Handles tambah.Click
        ...
        If baca.HasRows = True Then
            ...
            koneksi.Close()
            koneksi.Open()
            sql = "INSERT INTO tbl_det_beli(nonota, kode_brg, nama_brg, jml_beli,harga) VALUES ('" & txt_no_nota.Text & "','" & vkd & "','" & cb_nm_brg.Text & "','" & txt_jml.Text &
                "','" & txt_harga.Text & "')"
            cmd.Dispose()
            cmd = New SqlClient.SqlCommand(sql)
            cmd.Connection = koneksi
    ...
    Private Sub HAPUS_Click(sender As Object, e As EventArgs) Handles HAPUS.Click
        ...
        koneksi.Close()
        koneksi.Open()
        sql = "delete from tbl_det_beli where kode_brg='" & vkd & "' and nonota ='" & txt_no_nota.Text & "'"
        cmd.Dispose()
        cmd = New SqlClient.SqlCommand(sql)
        cmd.Connection = koneksi
        cmd.ExecuteNonQuery()
    ...
    Private Sub txt_nama_sup_TextChanged(sender As Object, e As EventArgs) Handles txt_nama_sup.TextChanged
