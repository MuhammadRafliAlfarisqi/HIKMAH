Public Class frm_menu
    ...
    Private Sub LapBarangToolStripMenuItem_Click(sender As Object, e As EventArgs)
        report_brg.Show()
    End Sub

    Private Sub LapToolStripMenuItem_Click(sender As Object, e As EventArgs)
        report_pel.Show()
    End Sub

    Private Sub LapSupplierToolStripMenuItem_Click(sender As Object, e As EventArgs)
        report_sup.Show()
    End Sub
    ...
    Private Sub LaporanDetPenjualanToolStripMenuItem_Click(sender As Object, e As EventArgs)
        LaporanJual.Show()
    End Sub

    Private Sub LapToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles LapToolStripMenuItem1.Click
        report_pembelian.Show()
    End Sub

    Private Sub LapDetPembelianToolStripMenuItem_Click(sender As Object, e As EventArgs)
