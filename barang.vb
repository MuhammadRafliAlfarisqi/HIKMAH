Public Class barang
    ...
    Private Sub barang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call buka()
        Call tampil()
        cb_kategori.Items.Add("Peralatan Sekolah")
        cb_kategori.Items.Add("Peralatan Perkantoran")
        cb_kategori.Items.Add("Alat Tulis")
    End Sub
    ...
    Sub atur()
        With DataGridView1.ColumnHeadersDefaultCellStyle
            ...
            DataGridView1.Columns(1).HeaderText = "nama_menu"
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles btn_simpan.Click
        ...
        If baca.HasRows = False Then
            koneksi.Close()
            koneksi.Open()
            sql = "INSERT INTO tbl_barang VALUES('" & Txt_id.Text & "','" & Txt_Nm_Brg.Text & "','" & Txt_harga.Text & "' ,'" & txt_Stok.Text & "','" &
                 cb_kategori.Text & "')"
            cmd.Dispose()
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        Call buka()
        sql = "update tbl_barang set nama_brg ='" & Txt_Nm_Brg.Text & "',harga ='" & Txt_harga.Text & "', stok='" &
